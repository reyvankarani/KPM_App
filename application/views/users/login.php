    ...
    <div class="container">
      <!-- Flash Messages -->
          ...
          <?php if($this->session->flashdata('success_verify')): ?>
            <?php echo '<div class="alert alert-success" role="alert">'.$this->session->flashdata('success_verify').'</div>'; ?>
          <?php endif; ?>
          <?php if($this->session->flashdata('usernotfound')): ?>
            <?php echo '<div class="alert alert-danger" role="alert">'.$this->session->flashdata('usernotfound').'</div>'; ?>
          <?php endif; ?>
          <?php if($this->session->flashdata('falsetoken')): ?>
            <?php echo '<div class="alert alert-danger" role="alert">'.$this->session->flashdata('falsetoken').'</div>'; ?>
          <?php endif; ?>  
          <?php if($this->session->flashdata('login_failed')): ?>
            <?php echo '<div class="alert alert-danger" role="alert">'.$this->session->flashdata('login_failed').'</div>'; ?>
          <?php endif; ?>
          <?php if($this->session->flashdata('emailnotactive')): ?>
            <?php echo '<div class="alert alert-danger" role="alert">'.$this->session->flashdata('emailnotactive').'</div>'; ?>
          <?php endif; ?>
          <?php if($this->session->flashdata('logout_success')): ?>
            <?php echo '<div class="alert alert-success" role="alert">'.$this->session->flashdata('logout_success').'</div>'; ?>
          <?php endif; ?>
          <?php if($this->session->flashdata('resetpasswordfailed')): ?>
            <?php echo '<div class="alert alert-danger" role="alert">'.$this->session->flashdata('resetpasswordfailed').'</div>'; ?>
          <?php endif; ?>
          <?php if($this->session->flashdata('resetpasswordtoken')): ?>
            <?php echo '<div class="alert alert-danger" role="alert">'.$this->session->flashdata('resetpasswordtoken').'</div>'; ?>
          <?php endif; ?>
          <?php if($this->session->flashdata('resetpasswordsuccess')): ?>
            <?php echo '<div class="alert alert-success" role="alert">'.$this->session->flashdata('resetpasswordsuccess').'</div>'; ?>
          <?php endif; ?>
            ...
            <div class="card text-white bg-primary py-5 d-md-down-none" style="width:44%">
              <div class="card-body text-center">
                <div>
                  <br><br>
                  <h2>Sign up</h2>
                  <a href="<?php echo base_url(); ?>users/register"><button class="btn btn-primary active mt-3" type="button">Register Now!</button></a>
                </div>
              </div>
            </div>
          </div>
